...
{
    public static InteractionBuilder WithContent(this InteractionBuilder builder, string content)
    {
    ...
    public static InteractionBuilder WithMentions(this InteractionBuilder builder, IAllowedMentions mentions)
    {
        return builder with { Mentions = new(mentions) };
    }

    public static InteractionBuilder AsEphemeral(this InteractionBuilder builder, bool isEphemeral = true)
    {
        return builder with { IsEphemeral = isEphemeral };
    }
    ...
    public static InteractionBuilder WithType(this InteractionBuilder builder, InteractionCallbackType type)
    {
        return builder with { Type = type };
    }
