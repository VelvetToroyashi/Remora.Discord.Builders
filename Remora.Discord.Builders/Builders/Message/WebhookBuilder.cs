...
{
    public static WebhookBuilder WithContent(this WebhookBuilder builder, string content) => builder with { Content = content };

    public static WebhookBuilder WithUsername(this WebhookBuilder builder, string username) => builder with { Username = username };

    public static WebhookBuilder WithAvatarUrl(this WebhookBuilder builder, string avatarUrl) => builder with { AvatarUrl = avatarUrl };
    ...
    public static WebhookBuilder WithAllowedMentions(this WebhookBuilder builder, IAllowedMentions allowedMentions) => builder with { AllowedMentions = new(allowedMentions) };

    public static WebhookBuilder WithThreadID(this WebhookBuilder builder, Snowflake threadID) => builder with { ThreadID = new(threadID) };
    ...
    public static WebhookBuilder AsEphemeral(this WebhookBuilder builder, bool ephemeral = true) => builder with { IsEphemeral = new(ephemeral) };

    public static WebhookBuilder WithThreadName(this WebhookBuilder builder, string threadName) => builder with { ThreadName = threadName };
