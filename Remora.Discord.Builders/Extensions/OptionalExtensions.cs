...
public static class OptionalExtensions
{
    ...
    public static T ValueOr<T>(this Optional<T> @this, T value)
    {
    ...
    public static T ValueOr<T>(this Optional<T> @this) where T : class, new()
    {
        return @this.HasValue ? @this.Value : new();
    }
}